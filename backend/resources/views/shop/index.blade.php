...
<div class="container">
    ...
    <table class="table">
        <a href="{{ route('shop.create') }}" class="btn btn-primary">Shop Add</a>
        <thead>
          <tr>
            <th scope="col">#</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <img src="/{{ $item->shop_img  }}" alt="" height="100px" width="150px"> </td>
                <td>{{ $item->status  }}</td>
                <td><div class="btn-group" role="group" aria-label="Basic example">
                    {{-- <a href="{{ route('shop.edit') }}/{{ $item->id  }}" class="btn btn-primary">Edit</a> --}}
